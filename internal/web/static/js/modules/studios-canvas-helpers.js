  ...
  content.innerHTML = `
    ...
    <div style="border-top: 1px solid var(--border-color); padding-top: 0.75rem;">
      <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <a href="/agents/${encodeURIComponent(agent.name)}" class="modern-btn modern-btn-secondary" style="padding: 4px 8px; font-size: 0.7rem; text-decoration: none;" title="Configure plugins for this agent">
      ...
      <div class="small" style="color: var(--text-secondary);">
        ...
        `).join('') : `
          <div class="text-center py-3" style="color: var(--text-muted);">
            ...
            <div class="mt-2">
              <a href="/agents/${encodeURIComponent(agent.name)}" class="modern-btn modern-btn-primary" style="padding: 6px 12px; font-size: 0.75rem; text-decoration: none;">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" class="me-1">
