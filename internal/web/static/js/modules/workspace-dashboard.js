              ...
              <div class="task-item">
                <div class="task-header">
                  ...
                  <div class="d-flex align-items-center gap-2">
                    ...
                    ${task.to && (task.status === 'pending' || task.status === 'assigned') ? `
                    <button class="modern-btn modern-btn-primary btn-sm" onclick="executeTask('${escapeHtml(task.id)}')" title="Execute task now">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" class="me-1">
