...
import {
  ...
  buildMapMetadata,
  folderDisplayFor
} from './workspace-map-snapshot.js';
...
// The tree-shaping helpers live in workspace-map-snapshot.js so the group
// page's Detachment map can build the same snapshot without this coordinator.
export {
  normalizeKind,
  isGroupWorkspace,
  flattenWorkspaceTree,
