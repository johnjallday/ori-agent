...
class ThemeManager {
  ...
  getThemeColors() {
    return {
      primary:
        this.getCSSVariable('--primary-color') || (this.isDarkMode() ? '#007bff' : '#0d6efd'),
      secondary:
        this.getCSSVariable('--secondary-color') || (this.isDarkMode() ? '#6c757d' : '#6c757d'),
      success:
        this.getCSSVariable('--success-color') || (this.isDarkMode() ? '#198754' : '#28a745'),
      danger: this.getCSSVariable('--danger-color') || (this.isDarkMode() ? '#dc3545' : '#dc3545'),
      warning:
        this.getCSSVariable('--warning-color') || (this.isDarkMode() ? '#ffc107' : '#ffc107'),
      info: this.getCSSVariable('--info-color') || (this.isDarkMode() ? '#0dcaf0' : '#17a2b8'),
      background:
        this.getCSSVariable('--bg-primary') || (this.isDarkMode() ? '#212529' : '#ffffff'),
      ...
      textSecondary:
        this.getCSSVariable('--text-secondary') || (this.isDarkMode() ? '#adb5bd' : '#6c757d'),
