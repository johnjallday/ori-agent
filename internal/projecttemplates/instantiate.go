...
// substituteTokens replaces the supported tokens in a path name. Both
// replacement values are slug/date strings (lowercase alphanumerics and
// hyphens), so substitution can never introduce path separators.
