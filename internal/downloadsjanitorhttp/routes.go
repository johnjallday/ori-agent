...
func (h *Handler) Register(mux *http.ServeMux) {
	...
	mux.HandleFunc("PATCH /api/workspaces/{workspaceID}/downloads-janitor/settings", h.UpdateSettings)
	mux.HandleFunc("POST /api/workspaces/{workspaceID}/downloads-janitor/content-consent", h.GrantConsent)
	mux.HandleFunc("POST /api/workspaces/{workspaceID}/downloads-janitor/relink", h.Relink)
	mux.HandleFunc("POST /api/workspaces/{workspaceID}/downloads-janitor/revoke", h.RevokeAccess)
	mux.HandleFunc("GET /api/workspaces/{workspaceID}/downloads-janitor/skipped", h.ListSkipped)
