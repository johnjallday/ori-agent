// Package filejanitor implements the File Janitor domain: the
...
// unknown timezone.
var ErrInvalidSettings = errors.New("invalid file janitor settings")

// JanitorSettings is one workspace's File Janitor configuration. It is
