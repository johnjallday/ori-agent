...
func (h *Handler) Register(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /api/workspaces/{workspaceID}/reaper/track-plan", h.GetPendingPlan)
	mux.HandleFunc("POST /api/workspaces/{workspaceID}/reaper/track-plan/apply", h.ApplyPendingPlan)
	mux.HandleFunc("DELETE /api/workspaces/{workspaceID}/reaper/track-plan", h.CancelPendingPlan)
	...
	mux.HandleFunc("POST /api/workspaces/{workspaceID}/reaper/scripts/{scriptID}/pin", h.PinScript)
	mux.HandleFunc("DELETE /api/workspaces/{workspaceID}/reaper/scripts/{scriptID}/pin", h.UnpinScript)
	mux.HandleFunc("PUT /api/workspaces/{workspaceID}/reaper/pinned-scripts", h.ReorderPinnedScripts)
