...
var builtinServers = []RegistryEntry{
	...
	},
	{
		...
		Command:     "uvx",
		Args:        []string{"mcp-server-sqlite", "--db-path", "/path/to/db.sqlite"},
		Transport:   "stdio",
		Category:    "database",
		Maintainer:  "Anthropic",
	...
	},
	{
		...
		Tags:        []string{"browser", "automation", "playwright", "web"},
	},
	{
		Name:        "puppeteer",
		Description: "Legacy browser automation using Puppeteer MCP (deprecated upstream)",
		Command:     "npx",
